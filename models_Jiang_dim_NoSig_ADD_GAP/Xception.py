...
class TIM_Module(nn.Module):
    ...
    def feat_ht(self, feat):
        ...
        feat_ht_out = self.ht_up_conv(0.25 * diff_feat_fwd + 0.25 * diff_feat_fwd1 + 0.25 * diff_feat_fwd2 + 0.25 * diff_feat_fwd3)
    ...
    def feat_tw(self, feat):
        ...
        feat_tw_out = self.tw_up_conv(0.25 * diff_feat_fwd + 0.25 * diff_feat_fwd1 + 0.25 * diff_feat_fwd2 + 0.25 * diff_feat_fwd3)
